...
<body>
        ...
        <div class="contents order-2 order-md-1">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-7">
                        <h3 style=" margin-left: 80px; margin-bottom:30px;"><strong>Đăng ký tập thử</strong></h3>
                        ...
                        <a class="already-signup" href="./dieukien.php">Bạn đã có tài khoản</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="./login/js/register-tapthu.js"></script>
</body>
