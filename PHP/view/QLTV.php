        ...
        <div class="right">
            <div class="qltv">
                ...
                <button type="button" class="add-btn">
                        <a href="./dangky.php" class="add-btn__link">Đăng ký thành viên</a>
                    </button>
                    <input type="text"  name="searchtv"  placeholder="Nhập Tên, SDT">
                ...
                <div class="list-container">
                    ...
                    $q = new cThanhVien();
                    if(isset($_REQUEST['searchtv']))
                    {
                        $kq= $q->timkiemtv($_REQUEST['searchtv']);
                    }
                    else{
                        $kq = $q->getAllTV();
                    }
...
<style>
        .add-btn {
            ...
            height: 40px;
            border-radius: 6px;
            background-color:#3eb823 !important;
            color: #fff !important;
        ...
        .add-btn:hover {
            background-color: #04570b !important;
            color: #fff !important;
