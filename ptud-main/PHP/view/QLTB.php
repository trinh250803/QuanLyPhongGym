        ...
        <div class="right">
            <div class="qltv">
                ...
                <button type="button" class="add-btn">
                        <a href="./themthietbi.php" class="add-btn__link">Thêm thiết bị</a>
                    </button>
                    <form method="post">
                    <input type="text" name="searchtb" placeholder="Tìm thiết bị">
                ...
                <div class="list-container">
                    ...
                    $p = new cThietBi();
                    if(isset($_REQUEST['searchtb']))
                    {
                        $tbl=$p->timkiemtb($_REQUEST['searchtb']);
                    }
                    else
                    {
                        $tbl = $p->getAllTB(); 
